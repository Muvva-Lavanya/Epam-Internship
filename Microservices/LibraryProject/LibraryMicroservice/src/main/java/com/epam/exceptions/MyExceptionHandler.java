...
public class MyExceptionHandler {
	...
	public ExceptionResponse handleDataIntegrityException(DataIntegrityViolationException e, WebRequest request) {
		...
		return new ExceptionResponse(new Date().toString(), HttpStatus.OK.toString(),"Book with name already exists, please try with another book name",
	...
	public ExceptionResponse handleElementNotFoundException(HttpClientErrorException e, WebRequest request) {
