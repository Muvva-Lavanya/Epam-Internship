...
class QuestionLibraryServiceTest {
	...
	void testCreateQuestion() throws RedundantQuestionException {
		...
		Mockito.when(questionDaoJpaImpl.viewAllQuestions()).thenReturn(questions);
		Mockito.when(questionDaoJpaImpl.saveQuestion(question3)).thenReturn(question3);
		...
		Mockito.verify(questionDaoJpaImpl).saveQuestion(question3);
	...
	void testCreateExistingQuestion() throws RedundantQuestionException {
		List<Question> questions=Arrays.asList(question1,question2);
		Mockito.when(questionDaoJpaImpl.viewAllQuestions()).thenReturn(questions);
		assertThrows(RedundantQuestionException.class,()->questionLibraryServicesImpl.createQuestion(question2));
		Mockito.verify(questionDaoJpaImpl).viewAllQuestions();
	...
	void testdeleteExistingQuestion() throws QuestionNotFoundException {
		question1.setId(1);
		Mockito.when(questionDaoJpaImpl.viewQuestionById(1)).thenReturn(question1);
		Mockito.doNothing().when(questionDaoJpaImpl).deleteQuestion(1);
	...
	void testdeleteUnExistingQuestion() throws QuestionNotFoundException {
		Mockito.when(questionDaoJpaImpl.viewQuestionById(1000)).thenReturn(null);
	...
	void viewExistingQuestionById() throws QuestionNotFoundException {
		question1.setId(2);
		Mockito.when(questionDaoJpaImpl.viewQuestionById(2)).thenReturn(question1);
		Question retrivedQuestion = questionLibraryServicesImpl.viewById(2);
		Mockito.verify(questionDaoJpaImpl, times(2)).viewQuestionById(2);
	...
	void updateTagForExistingQuestion() {
		question2.setId(2);
		Mockito.when(questionDaoJpaImpl.viewQuestionById(2)).thenReturn(question2);
		question2.setTag("java");
		Mockito.when(questionDaoJpaImpl.updateQuestion(question2)).thenReturn(question2);
		String message = questionLibraryServicesImpl.updateTag(2, "java");
		Mockito.verify(questionDaoJpaImpl, times(2)).viewQuestionById(2);
		Mockito.verify(questionDaoJpaImpl).updateQuestion(question2);
	...
	void updateWrongDifficultyLevelForExistingQueztion() {
		...
		question2.setId(3);
		Mockito.when(questionDaoJpaImpl.viewQuestionById(3)).thenReturn(question2);
		question2.setDifficultyLevel("Easy1");
		String message = questionLibraryServicesImpl.updateDifficulty(3, "Easy1");
		Mockito.verify(questionDaoJpaImpl).viewQuestionById(3);
	...
	void updateOptionsForExistingQuestion() {
		...
		Mockito.verify(questionDaoJpaImpl, times(2)).viewQuestionById(3);
	...
	void updateWrongOptions1ForExistingQuestion() {
		question2.setId(4);
		Mockito.when(questionDaoJpaImpl.viewQuestionById(4)).thenReturn(question2);
		String message = questionLibraryServicesImpl.updateOptions(4, 5, "1");
		Mockito.verify(questionDaoJpaImpl, times(2)).viewQuestionById(4);
	...
	void updateWrongAnswer1ForExistingQuestion() {
		question2.setId(5);
		Mockito.when(questionDaoJpaImpl.viewQuestionById(5)).thenReturn(question2);
		String message = questionLibraryServicesImpl.updateAnswer(5, 5);
		Mockito.verify(questionDaoJpaImpl, times(2)).viewQuestionById(5);
