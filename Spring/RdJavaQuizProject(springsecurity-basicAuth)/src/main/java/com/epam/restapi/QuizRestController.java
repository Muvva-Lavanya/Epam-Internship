...
public class QuizRestController {
	...
	Logger logger = LogManager.getLogger(QuizRestController.class);

	@PostMapping
	public ResponseEntity<QuizDto> createQuiz(@Valid @RequestBody QuizDto quizDto,
			@RequestParam("questionIds") List<Integer> questionIds) {
		logger.info("Received post request to create Quiz");
	...
	public ResponseEntity<QuizDto> getQuizById(@PathVariable int id) {
		logger.info("Received get request to view quiz by id");
	...
	public ResponseEntity<QuizDto> deleteQuiz(@PathVariable int id) {
		logger.info("Received delete request to delete Quiz");
	...
	public ResponseEntity<List<Quiz>> getAllQuizzes() {
		logger.info("Received get request to view all quizzes");
	...
	public ResponseEntity<QuizDto> updateQuiz(@Valid @RequestBody QuizDto quizDto,
			@RequestParam("questionIds") List<Integer> questionIds) {
		logger.info("Received put request to update Quiz");
